...
FIG_DIR = os.path.join(os.path.dirname(HERE), "output")
...
def set_up():
    """Set default device and memory saving options."""
    ...
    # save memory
    Cockpit.BACKPACK_CONV_SAVE_MEMORY = True
...
def lr_schedule(num_epochs):
    ...
    Returns:
        [callable]: Lambda function of the learning rate schedule.
    """
...
class MemoryBenchmarkRunner(_DeepOBSRunner):
